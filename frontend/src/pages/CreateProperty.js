...
import { FiUpload, FiMapPin, FiHome, FiUsers, FiDollarSign } from 'react-icons/fi';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Add your property to start hosting</p>
        </div>
          ...
          <div className="card p-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Upload at least one image of your property (max 10 images)
              </p>
            </div>
          </div>
